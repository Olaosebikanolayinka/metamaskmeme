...
export default function Hero() {
  return (
    ...
    >
      ...
      ></div>
    <div
  className="hero-card animate-fade-in-up relative z-10 bg-gradient-to-br from-black/90 via-gray-900/90 to-gray-800/90 rounded-3xl shadow-2xl backdrop-blur-lg flex flex-col items-center ml-[5vw] border border-amber-600/20"
        style={{
      ...
      >
        <h1
          className="text-3xl md:text-4xl font-bold mb-5 text-amber-600 w-full drop-shadow-lg text-center"
