...
export default function Navbar() {
  ...
  const navLinks = ["about", "how-to-buy", "tokenomics", "roadmap", "whitepaper"];
  return (
    <>
      <nav className="fixed top-4 left-0 w-full z-50">
        <div className="max-w-6xl mx-auto bg-black backdrop-blur-md shadow-md rounded-2xl px-6 py-3 flex justify-between items-center relative">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            />
            <h1 className="text-xl sm:text-2xl md:text-4xl font-extrabold tracking-wide text-amber-500 drop-shadow-lg" style={{letterSpacing: '0.04em'}}>Metamaskmeme</h1>
          </div>
          ...
          <ul
            className={`md:flex gap-6 text-gray-300 font-medium text-xs md:text-sm transition-all duration-300 pl-4 md:pl-8 ${open ? 'flex flex-col absolute top-16 left-0 w-full bg-gray-900/95 rounded-b-2xl py-6 px-8 shadow-lg z-40' : 'hidden md:flex static'}`}
